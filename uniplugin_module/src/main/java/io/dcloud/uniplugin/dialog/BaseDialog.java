...
import io.dcloud.uniplugin.dialog.CornerRound;
import io.dcloud.uniplugin.dialog.DialogLog;
...
public abstract class BaseDialog extends Dialog implements DialogInterface.OnShowListener, DialogInterface.OnDismissListener {
    ...
    protected void onInit(@NonNull Activity activity, @Nullable Bundle savedInstanceState) {
        io.dcloud.uniplugin.dialog.DialogLog.print("dialog onInit");
    }
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        io.dcloud.uniplugin.dialog.DialogLog.print("dialog onCreate");
        if (contentView == null) {
            readyView();
        }
    }
    ...
    protected void initView(View contentView) {
        io.dcloud.uniplugin.dialog.DialogLog.print("dialog initView");
    }
    ...
    public void dismiss() {
        ...
        try {
            super.dismiss();
            io.dcloud.uniplugin.dialog.DialogLog.print("dialog dismiss");
        } catch (Exception e) {
            //...not attached to window manager
            //...Activity...has leaked window...that was originally added here
            io.dcloud.uniplugin.dialog.DialogLog.print(e);
    ...
    public void onAttachedToWindow() {
        io.dcloud.uniplugin.dialog.DialogLog.print("dialog attached to window");
    ...
    protected void initData() {
        io.dcloud.uniplugin.dialog.DialogLog.print("dialog initData");
    }
    ...
    public void onDetachedFromWindow() {
        ...
        io.dcloud.uniplugin.dialog.DialogLog.print("dialog detached from window");
    }
    ...
    public void onShow(DialogInterface dialog) {
        io.dcloud.uniplugin.dialog.DialogLog.print("dialog onShow");
    }
