...
public abstract class ModalDialog extends BottomDialog implements View.OnClickListener {
    ...
    public ModalDialog(@NonNull Activity activity) {
        super(activity, DialogConfig.getDialogStyle() == io.dcloud.uniplugin.dialog.DialogStyle.Three
    ...
    public void onInit(@Nullable Bundle savedInstanceState) {
        ...
        if (DialogConfig.getDialogStyle() == io.dcloud.uniplugin.dialog.DialogStyle.Three) {
    ...
    protected boolean enableMaskView() {
        return DialogConfig.getDialogStyle() != io.dcloud.uniplugin.dialog.DialogStyle.Three;
    }
    ...
    protected View createHeaderView() {
        switch (DialogConfig.getDialogStyle()) {
            case io.dcloud.uniplugin.dialog.DialogStyle.One:
                return View.inflate(activity, R.layout.dialog_header_style_1, null);
            case io.dcloud.uniplugin.dialog.DialogStyle.Two:
                return View.inflate(activity, R.layout.dialog_header_style_2, null);
            case io.dcloud.uniplugin.dialog.DialogStyle.Three:
    ...
    protected View createTopLineView() {
        if (DialogConfig.getDialogStyle() == io.dcloud.uniplugin.dialog.DialogStyle.Default) {
    ...
    protected void initView() {
        ...
        switch (DialogConfig.getDialogStyle()) {
            case io.dcloud.uniplugin.dialog.DialogStyle.One:
            case io.dcloud.uniplugin.dialog.DialogStyle.Two:
                setBackgroundColor(io.dcloud.uniplugin.dialog.CornerRound.Top, color);
                break;
            case io.dcloud.uniplugin.dialog.DialogStyle.Three:
                setBackgroundColor(io.dcloud.uniplugin.dialog.CornerRound.All, color);
                break;
            default:
    ...
    private void maybeBuildEllipseButton() {
        if (DialogConfig.getDialogStyle() != io.dcloud.uniplugin.dialog.DialogStyle.One && DialogConfig.getDialogStyle() != io.dcloud.uniplugin.dialog.DialogStyle.Two) {
            return;
        }
        if (DialogConfig.getDialogStyle() == DialogStyle.Two) {
            ...
            if (background != null) {
                ...
                cancelView.setBackgroundResource(R.drawable.dialog_close_icon);
            }
        } else {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.dialog_modal_cancel) {
            io.dcloud.uniplugin.dialog.DialogLog.print("cancel clicked");
            onCancel();
            dismiss();
